...
Template.edit_item.events({
	...
	"click .save": function (event, template) {
		if (!has_empty_fields(template)) {
			...
			Meteor.call("edit_item", target_id, metadata);

			$("#add_item").removeClass("hidden");
			$("#view_" + target_id)
				.removeClass("hidden")
				.addClass("success");
