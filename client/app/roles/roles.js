...
Template.edit_role.events({
	...
	"click .save": function (event, template) {
		if (!has_empty_fields(template)) {
			...
			Meteor.call("edit_role", target_id, metadata);
