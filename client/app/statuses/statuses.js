...
Template.add_status.events({
	...
	"click #add": function (event, template) {
		if (!has_empty_fields(template)) {
			...
			Meteor.call("add_status", metadata);
...
Template.edit_status.events({
	...
	"click .save": function (event, template) {
		if (!has_empty_fields(template)) {
			...
			Meteor.call("edit_status", target_id, metadata);

			$("#add_status").removeClass("hidden");
			$("#view_" + target_id)
				.removeClass("hidden")
				.addClass("success");
